...
public class CurriculumMapper {
    public CurriculumResponse toResponse(TrainingCurriculum c) {
        return new CurriculumResponse(c.getId(), c.getName(), c.getVersion());
    }
    ...
    public CurriculumDetailResponse toDetailResponse(
            TrainingCurriculum c, List<CurriculumSkillResponse> skills) {
        return new CurriculumDetailResponse(c.getId(), c.getName(), c.getVersion(), skills);
    }
}
